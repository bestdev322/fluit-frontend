...
function CwaPage() {
  ...
  const expandedRowRender = (record: any): ReactNode => {
    const expandedRowRender = (record: any): ReactNode => {
      ...
      //Table 3
      return <Table columns={columns} dataSource={dataTable3[record.id]} expandable={{ expandedRowRender }} onExpandedRowsChange={(e) => setExpandedData3(e[e.length - 1])} showHeader={false} pagination={false} />;
    }
